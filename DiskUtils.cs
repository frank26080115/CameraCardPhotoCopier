...
namespace CameraCardPhotoCopier
{
    ...
    public static class DiskUtils
    {
        ...
        public static bool PreventRemovalOfVolume(IntPtr handle, bool prevent)
        {
            byte[] buf = new byte[1];
            uint retVal;
